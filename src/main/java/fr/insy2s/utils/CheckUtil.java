...
public class CheckUtil {
    public static String getLoginCurrentUser(){ return SecurityUtils.getCurrentUserLogin().get(); }
    ...
    public static Boolean checkIdUserHaveRightTochangeAccount(UserDTO userToChange) { return (isAdmin() || userToChange.getLogin().equals(getLoginCurrentUser())); }
