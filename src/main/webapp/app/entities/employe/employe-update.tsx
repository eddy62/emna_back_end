...
export const EmployeUpdate = (props: IEmployeUpdateProps) => {
  ...
  const { employeEntity, adresses, societes, loading, updating } = props;
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : employeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="employe-civilite" type="text" name="civilite" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                ...
                <AvField id="employe-telephonePortable" type="text" name="telephonePortable" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                ...
                <AvField id="employe-salaireHoraire" type="string" className="form-control" name="salaireHoraire" />
              </AvGroup>
              <AvGroup>
                ...
                <AvField id="employe-salaireBrutMensuelle" type="string" className="form-control" name="salaireBrutMensuelle" />
              </AvGroup>
              <AvGroup>
                ...
                <AvField id="employe-heuresMensuelle" type="string" className="form-control" name="heuresMensuelle" />
              </AvGroup>
              <AvGroup>
                <Label id="categorieLabel" for="employe-categorie">
                  <Translate contentKey="emnaBackEndApp.employe.categorie">Categorie</Translate>
                </Label>
                <AvField id="employe-categorie" type="text" name="categorie" />
              </AvGroup>
              <AvGroup>
                <Label id="statutLabel" for="employe-statut">
                  <Translate contentKey="emnaBackEndApp.employe.statut">Statut</Translate>
                </Label>
                <AvField id="employe-statut" type="text" name="statut" />
              </AvGroup>
              <AvGroup>
