    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {avenantEntity.dateDeCreation ? (
              <TextFormat value={avenantEntity.dateDeCreation} type="date" format={APP_LOCAL_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
            <span id="dateDeSignature">
              <Translate contentKey="emnaBackEndApp.avenant.dateDeSignature">Date De Signature</Translate>
            </span>
          </dt>
          <dd>
            {avenantEntity.dateDeSignature ? (
              <TextFormat value={avenantEntity.dateDeSignature} type="date" format={APP_LOCAL_DATE_FORMAT} />
            ) : null}
          </dd>
        </dl>
