...
import {deleteEntity, getEntity} from './absence.reducer';
...
export const AbsenceDeleteDialog = (props: IAbsenceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="emnaBackEndApp.absence.delete.question">
        <Translate contentKey="emnaBackEndApp.absence.delete.question" interpolate={{ id: absenceEntity.id }}>
